...
<script>
    layui.use(['layer','form','table','laydate'], function() {
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'edit'){
                var editIndex = layer.open({
                    title : "编辑博客标签",
                    type : 2,
                    content : "${base}/finance/admin/blogTags/edit?id="+data.id,
            ...
            if(obj.event === "del"){
                layer.confirm("你确定要删除该博客标签么？",{btn:['是的,我确定','我再想想']},
                        function(){
                            $.post("${base}/finance/admin/blogTags/delete",{"id":data.id},function (res){
                                if(res.success){
        ...
        var t = {
            elem: '#test',
            url:'${base}/finance/admin/blogTags/list',
            method:'post',
        ...
        var active={
            addBlogTags : function(){
                var addIndex = layer.open({
                    title : "添加博客标签",
                    type : 2,
                    content : "${base}/finance/admin/blogTags/add",
