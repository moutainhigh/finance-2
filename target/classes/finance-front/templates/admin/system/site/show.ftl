    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>
                ...
                <img <#if site.authorIcon??> src="${site.authorIcon}" <#else> src="${base}/finance/static/images/face.jpg " </#if> class="layui-circle" id="userFace" style="width: 100px;height: 100px">
            </td>
            <td>authorIcon</td>
        </tr>
        <tr>
...
<script>
    layui.use(['form','layer','jquery','upload'], function(){
        ...
        form.on('submit(site)',function(data){
            ...
            $.post('${base}/finance/admin/system/site/edit',data.field,function (res) {
