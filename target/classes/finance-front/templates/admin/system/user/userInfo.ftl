...
<head>
    ...
    <link rel="stylesheet" href="${base}/finance/static/css/user.css?v=2.0" media="all" />
</head>
...
<form class="layui-form">
    ...
    <div class="user_right">
        ...
        <img <#if (userinfo.icon??)>src="${userinfo.icon}" <#else> src="${base}/finance/static/images/face.jpg " </#if> class="layui-circle" id="userFace">
    </div>
...
<script>
    layui.use(['form','jquery','layer','upload','laydate'],function() {
        ...
        form.on("submit(changeUser)",function (data) {
            ...
            $.post("${base}/finance/admin/system/user/saveUserinfo",data.field,function(res){
