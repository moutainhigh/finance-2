...
<head>
    ...
    <!--本页样式表-->
    <link href="${base}/finance/static/blog/css/article.css?t=${.now?long}" rel="stylesheet" />
</head>
<body>
<!-- 导航 -->
                ...
                <#if pagelist??>
                    ...
                    <div class="article shadow">
                        <div class="article-left">
                            ...
                            <#else>
                                        <img src="${base}/finance/static/images/timg_meitu_2.jpg" alt="${item.title}" />
                            </#if>
                        </div>
    ...
    <div class="article shadow">
        ...
        <div class="article-right">
            <div class="article-title">
                ...
                <a href='${base}/finance/showBlog/articleContent/{{item.id}}'>{{ item.title.substring(0,100) }}</a>
                {{# }else{ }}
                <a href='${base}/finance/showBlog/articleContent/{{item.id}}'>{{ item.title }}</a>
                {{# } }}
            </div>
            <div class="article-abstract">
                {{item.text}}
...
<script>
    layui.use(['form','jquery','layer','laytpl','laypage'],function(){
        ...
        form.on("submit(formSearch)",function(data){
            ...
            $.post("${base}/finance/showBlog/search",data.field,function (res) {
                if(res.success){
                    $(".blog-main-left").html("");
