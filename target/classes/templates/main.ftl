    ...
    <#if (userMenu?size>0)>
        <#list userMenu as items>
            <div class="panel col <#if (!items_has_next)>max_panel</#if> ">
                <a href="javascript:" data-url="${base}/finance${items.href}">
...
<div class="row">
    ...
    <script type="text/javascript" src="${base}/finance/static/js/echarts.min.js"></script>
    <script type="text/javascript">
        ...
        $.get('${base}/finance/admin/system/log/pvs').done(function (res) {
            myChart.setOption({
                tooltip : {
                    show: true,
                    trigger: 'axis',
