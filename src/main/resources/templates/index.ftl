<#--<#assign base=request.contextPath+"/lisheng" />-->
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="${base}/finance/static/css/main.css" media="all"/>
</head>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" mobile>
                    <a href="${base}/finance/systemLogout" class="signOut"><i class="iconfont icon-loginout"></i> 退出</a>
                </li>
                ...
                <li class="layui-nav-item" pc>
                    <a href="javascript:">
                        <img src="<#if (currentUser.icon??)>${currentUser.icon}<#else>${base}/finance/static/images/face.jpg</#if>"
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${base}/finance/systemLogout" class="signOut"><i
        ...
        <div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="${base}/finance/main"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p>Copyright © 2018丽笙科技 Design By July <a href="http://www.miibeian.gov.cn" target="_blank">渝ICP备19913146号 </a>
        </p>
    </div>
</div>
