...
<script type="text/javascript" src="${base}/finance/static/js/tools.js?t=${.now?long}"></script>
<script>
    layui.use(['layer','form','table','laydate'], function() {
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'edit'){
                var editIndex = layer.open({
                    title : "回复博客评论",
                    type : 2,
                    content : "${base}/finance/admin/blogComment/edit?id="+data.id,
            ...
            if(obj.event === "del"){
                layer.confirm("你确定要删除该评论么？",{btn:['是的,我确定','我再想想']},
                        function(){
                            $.post("${base}/finance/admin/blogComment/delete",{"id":data.id},function (res){
                                if(res.success){
        ...
        var t = {
            elem: '#test',
            url:'${base}/finance/admin/blogComment/list',
            method:'post',
        ...
        var active={
            addBlogComment : function(){
                var addIndex = layer.open({
                    title : "添加博客评论",
                    type : 2,
                    content : "${base}/finance/admin/blogComment/add",
