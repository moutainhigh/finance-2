...
<head>
    ...
    <link rel="stylesheet" href="${base}/finance/static/colorpicker/colpick.css" media="all" />
    <style type="text/css">
...
<script type="text/javascript" src="${base}/finance/static/colorpicker/colpick.js"></script>
<script>
    var iconShow,$;
    layui.use(['form','jquery','layer'],function(){
        ...
        $("#selectIcon").on("click",function () {
            iconShow =layer.open({
                ...
                title: '选择图标',
                shadeClose: true,
                content: '${base}/finance/static/page/icon.html'
            });
            layer.full(iconShow);
        });
        ...
        form.on("submit(addUser)",function(data){
            ...
            $.post("${base}/finance/admin/system/menu/edit",data.field,function (res) {
