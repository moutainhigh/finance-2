...
<script>
    ...
    layui.use(['layer','form','table','laydate'], function() {
        ...
        $(function() {
            ...
            $.post("${base}/finance/admin/blogChannel/ztreeData",function (res) {
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'edit'){
                var editIndex = layer.open({
                    title : "编辑博客内容",
                    type : 2,
                    content : "${base}/finance/admin/blogArticle/edit?id="+data.id,
            ...
            if(obj.event === "del"){
                layer.confirm("你确定要删除该博客内容么？",{btn:['是的,我确定','我再想想']},
                        function(){
                            $.post("${base}/finance/admin/blogArticle/delete",{"id":data.id},function (res){
                                if(res.success){
        ...
        var t = {
            elem: '#test',
            url:'${base}/finance/admin/blogArticle/list',
            method:'post',
        ...
        var active={
            addBlogArticle : function(){
                var c = zTreeObj.getSelectedNodes(),url="${base}/finance/admin/blogArticle/add";
                if(c.length>0){
