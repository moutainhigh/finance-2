...
<script type="text/javascript" src="${base}/finance/static/js/pinyin.js"></script>
<script>
    var iconShow,$;
    layui.use(['form','jquery','layer'],function(){
        ...
        form.verify({
            blogHref: function(value, item){ //value：表单的值、item：表单的DOM对象
                ...
                flag = true;
                $.ajax({
                    url:'${base}/finance/admin/blogChannel/checkHref',
                    type:'POST',
        ...
        form.on("submit(addBlogChannel)",function(data){
            ...
            $.post("${base}/finance/admin/blogChannel/add",data.field,function(res){
