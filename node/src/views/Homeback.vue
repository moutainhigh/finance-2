...
<style scoped>
.home-box{width:100vw;height:100wh;background:url(/image/home/bg.png);}
...
.main .main-body .main-center .c-map{width:880px;height:794px;margin:0 auto;display:flex;justify-content:center;align-items:center;}
...
.main .main-body .main-center .c-bottom{position:absolute;bottom:34px;left:198px;}
